<sub><b>🌐 English</b> · <a href="README.zh.md">Chinese</a></sub>
...
>
> 📖 **For Chinese readers**: This skill was developed by Hua Shu (@AlchainHust). One sentence allows the agent to deliver **product launch animation/clickable app prototype/editable PPT/print-grade infographic** within 3–30 minutes. For the complete Chinese introduction, see [README.zh.md](README.zh.md).
...
| WeChat Official Account | Uncle Hua | Search "Uncle Hua" in WeChat |
| Bilibili | Uncle Hua | https://space.bilibili.com/14097567 |
| YouTube | Uncle Hua | https://www.youtube.com/@Alchain |
| Xiaohongshu | Uncle Hua | https://www.xiaohongshu.com/user/profile/5abc6f17e8ac2b109179dfdf |
